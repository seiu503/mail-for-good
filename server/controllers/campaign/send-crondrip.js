...
module.exports = (req, res, io, redis) => {
    ...
    function* sendCronDrip() {
        ...
        const { totalListSubscribers, totalEmailsToSend } = yield countListSubscribers(campaignInfo.listId, quotas.AvailableToday, dripId);
        ...
        campaignInfo.campaignAnalyticsId = yield updateAnalytics(campaignInfo.dripId, userId, totalEmailsToSend);
