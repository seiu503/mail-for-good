...
const sendCronCampaign = rewire('./send-croncampaign-sequence');

describe('sendCronCampaignSequence', () => {
    describe('howLongEmailingWillTake', () => {
        const howLongEmailingWillTake = sendCronCampaignSequence.__get__('howLongEmailingWillTake');
