...
const sendCronCampaign = rewire('./send-croncampaign');

describe('sendCronCampaign', () => {
    describe('howLongEmailingWillTake', () => {
        const howLongEmailingWillTake = sendCronCampaign.__get__('howLongEmailingWillTake');
