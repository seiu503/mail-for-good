...
export default class TextEditorRich extends Component {
    ...
    onUpload(e) {
        ...
        reader.onload = function (evt) {
            var field_name = ($('#page_name').text() == '/campaigns/create') ? 'emailBodyHTML' : 'emailBody';
    ...
    render() {
        ...
        return (
            <div>                
                ...
                <div hidden={true}>
                <Field name={($('#page_name').text() == '/campaigns/create') ? 'emailBodyHTML' : 'emailBody'} component={renderField} label="EmailBody" type="text"/>
                </div>
                <div>
                    <Editor
                        readOnly={false}
