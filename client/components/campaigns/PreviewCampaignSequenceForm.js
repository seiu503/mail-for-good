...
const PreviewCampaignSequenceForm = props => {
    ...
    const isCreateSequencePreview = !!props.form;
    let text;
    let form;
    let type;
    if (isCreateSequencePreview) {
        ...
        // In this case, the preview is rendered within the sequenceView container
        // We may receive plaintext or html from the server.
        form = props.sequenceView;
        type = form.type;
        text = props.sequenceView.emailBody;
    }
    ...
    return (
        <div>
            ...
            <h4><strong>Day After: {form.sequenceday}</strong></h4>
            ...
            {!isCreateSequencePreview && <hr />}
            {(lastPage && handleSubmit) &&
                <div className="box-footer">
                    <div className="btn-group">
                        <button style={{ margin: "1em", width: "250px" }} className="btn btn-lg btn-success" type="button" onClick={handleSubmit}>Create Campaign Sequence</button>
