...
export class ImportCSVComponent extends Component {
  ...
  static propTypes = {
    ...
    handleTermConditions: PropTypes.func.isRequired
  }
  ...
  handleTermConditionsChange(e) {
    this.props.handleTermConditions(e.target.checked);
  }
  cancelImport() {
    this.props.handleTermConditions(false);
    this.setState({
      subscribers: null,
      fields: null,
      errors: null
          ...
          : <Row>
            <Col md={12}>
              ...
              and clicking the label is equivalent to clicking the input*/}
                ...
                {this.state.subscribers && <div> <br />
                  <div><label><input id="term_conditions" type="checkbox" onChange={this.handleTermConditionsChange.bind(this)} /> I read and understand the <a target="_blank" href="https://www.pardot.com/legal/permission-based-marketing-policy/">terms and conditions.</a> </label></div></div>}
              </div>
