...
// DripACtions
export const REQUEST_POST_CREATEDRIP = "REQUEST_POST_CREATEDRIP";
export const COMPLETE_POST_CREATEDRIP = "COMPLETE_POST_CREATEDRIP";
export const REQUEST_POST_SUBMITDRIP = "REQUEST_POST_SUBMITDRIP";
export const COMPLETE_POST_SUBMITDRIP = "COMPLETE_POST_SUBMITDRIP";
export const REQUEST_GET_DRIPS = "REQUEST_GET_DRIPS";
export const COMPLETE_GET_DRIPS = "COMPLETE_GET_DRIPS";
export const COMPLETE_GET_DRIP_SEQUENCES = "COMPLETE_GET_DRIP_SEQUENCES";
export const COMPLETE_DELETE_DRIPS = "COMPLETE_DELETE_DRIPS";

// campaignActions
export const REQUEST_POST_CREATECAMPAIGNSEQUENCE =
  "REQUEST_POST_CREATECAMPAIGNSEQUENCE";
export const COMPLETE_POST_CREATECAMPAIGNSEQUENCE =
...
export const COMPLETE_DELETE_CAMPAIGNSEQUENCE =
  "COMPLETE_DELETE_CAMPAIGNSEQUENCE";

export const REQUEST_POST_CREATECAMPAIGN = "REQUEST_POST_CREATECAMPAIGN";
export const REQUEST_POST_DRAFTCAMPAIGN = "REQUEST_POST_DRAFTCAMPAIGN";
export const COMPLETE_POST_DRAFTCAMPAIGN = "COMPLETE_POST_DRAFTCAMPAIGN";
...
export const REQUEST_POST_PUBLISHTEMPLATE = "REQUEST_POST_PUBLISHTEMPLATE";
export const COMPLETE_POST_PUBLISHTEMPLATE = "COMPLETE_POST_PUBLISHTEMPLATE";
...
export const COMPLETE_DELETE_LIST_SUBSCRIBERS =
...
export const REQUEST_DELETE_GRANT_PERMISSION =
  "REQUEST_DELETE_GRANT_PERMISSION";
export const COMPLETE_DELETE_GRANT_PERMISSION =
...
export const COMPLETE_GET_ACTIVE_PERMISSIONS =
  "COMPLETE_GET_ACTIVE_PERMISSIONS";
export const REQUEST_DELETE_ACTIVE_PERMISSIONS =
  "REQUEST_DELETE_ACTIVE_PERMISSIONS";
export const COMPLETE_DELETE_ACTIVE_PERMISSIONS =
...
export const REQUEST_GET_RECEIVED_PERMISSION_OFFERS =
  "REQUEST_GET_RECEIVED_PERMISSION_OFFERS";
export const COMPLETE_GET_RECEIVED_PERMISSION_OFFERS =
  "COMPLETE_GET_RECEIVED_PERMISSION_OFFERS";
export const REQUEST_POST_ACCEPT_RECEIVED_PERMISSION_OFFERS =
  "REQUEST_POST_ACCEPT_RECEIVED_PERMISSION_OFFERS";
export const COMPLETE_POST_ACCEPT_RECEIVED_PERMISSION_OFFERS =
  "COMPLETE_POST_ACCEPT_RECEIVED_PERMISSION_OFFERS";
export const REQUEST_DELETE_REJECT_RECEIVED_PERMISSION_OFFERS =
  "REQUEST_DELETE_REJECT_RECEIVED_PERMISSION_OFFERS";
export const COMPLETE_DELETE_REJECT_RECEIVED_PERMISSION_OFFERS =
...
export const REQUEST_GET_GRANT_OFFERED_PERMISSIONS =
  "REQUEST_GET_GRANT_OFFERED_PERMISSIONS";
export const COMPLETE_GET_GRANT_OFFERED_PERMISSIONS =
  "COMPLETE_GET_GRANT_OFFERED_PERMISSIONS";
export const REQUEST_DELETE_GRANT_OFFERED_PERMISSIONS =
  "REQUEST_DELETE_GRANT_OFFERED_PERMISSIONS";
export const COMPLETE_DELETE_GRANT_OFFERED_PERMISSIONS =
