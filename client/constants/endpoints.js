...
// Prepare Drip Sequence
export const API_PREPARE_DRIP_SEQUENCE_ENDPOINT =
  BASE_URL + "/api/prepare-drip-sequence";
...
export const API_CAMPAIGN_SEQUENCE_ENDPOINT =
  BASE_URL + "/api/campaignsequence"; // REST (post = new campaign, get = get list of campaigns, put = update campaign, del = delete campaign)
export const API_CAMPAIGN_SEQUENCE_LISTING_ENDPOINT =
  BASE_URL + "/api/campaignsequencelisting"; // REST (post = new campaign, get = get list of campaigns, put = update campaign, del = delete campaign)
...
export const API_SEND_CRON_CAMPAIGN_SEQUENCE_ENDPOINT =
  BASE_URL + "/api/cronsendsequence";
...
export const API_CAMPAIGN_CHANGE_STATUS_ENDPOINT =
  BASE_URL + "/api/changecampaignstatus";
...
export const API_SFREPORTDETAILS_ENDPOINT =
  BASE_URL + "/api/salesforcereportsdetails";
...
export const API_GRANT_OFFERED_PERMISSIONS_ENDPOINT =
  "/api/grant-offered-permissions";
